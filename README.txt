...
pyhton generate_tags.py [all] generate all tag ID 0-511 . [<number>] generate <number> ID tag


USE_THE_CLASS_INTERFACE:

Extend the Class Image_Processor.Detector to use the camera
